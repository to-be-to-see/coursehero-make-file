...
for count in range(int(loop_count)):
    input_box.clear()
    if subject_choice == 1:
        input_box.send_keys("Make notes about "+random.choice(physics_topics))
    if subject_choice == 2:
        input_box.send_keys("Make notes about "+random.choice(chemistry_topics))
    else:
        input_box.send_keys("Make notes about "+random.choice(biology_topics))
